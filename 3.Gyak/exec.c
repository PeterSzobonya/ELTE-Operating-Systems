...
// exec után lehet még v, mint vector mint ebben a példában vagy l ami egy list erre egy egyszerá példa lehet a következő:
...
int main()
{
   ...
   else //child process
   {
      ...
      char *cmd = "./write";
      char *arg[] = {"./write", "Operating Systems", "5", NULL}; // NULL -> No more argument
